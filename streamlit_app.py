...
def main():
    ...
    input_data['Polyuria'] = st.selectbox("Symptoms of Polyuria:", ['No', 'Yes'])
    input_data['Polydipsia'] = st.selectbox("Symptoms of Polydipsia:", ['No', 'Yes'])
    ...
    input_data['Polyphagia'] = st.selectbox(" Symptoms of Polydphagia:", ['No', 'Yes'])
    input_data['Genital thrush'] = st.selectbox(" Symptoms of Genital thrush:", ['No', 'Yes'])
    ...
    input_data['partial paresis'] = st.selectbox(" Symptoms of partial paresis:", ['No', 'Yes'])
    input_data['muscle stiffness'] = st.selectbox(" Symptoms of muscle stiffness:", ['No', 'Yes'])
    input_data['Alopecia'] = st.selectbox(" Symptoms of alopecia:", ['No', 'Yes'])
    input_data['Obesity'] = st.selectbox(" Signs of Obesity:", ['No', 'Yes'])
